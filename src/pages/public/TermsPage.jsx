      ...
      <section className="relative overflow-hidden bg-slate-950 py-16 sm:py-20 lg:py-24 text-white">
        <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-4xl font-bold tracking-[-0.02em] text-white sm:text-5xl">Terms of Service</h1>
            ...
            <div className="mt-10 space-y-10 text-slate-300">
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">Use of service</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">Intellectual property</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">Limitation of liability</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">Subscriptions and services</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-white">Contact</h2>
