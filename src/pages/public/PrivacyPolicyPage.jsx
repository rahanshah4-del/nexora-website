        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-10 space-y-10 text-slate-700">
              ...
              <section>
                <h2 className="text-xl font-semibold text-slate-950">Cookies and tracking</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-slate-950">Business service requests</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-slate-950">Contact and data questions</h2>
