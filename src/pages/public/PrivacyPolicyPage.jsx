      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-4xl font-bold tracking-[-0.02em] text-slate-950 sm:text-5xl">Privacy Policy</h1>
            ...
            <div className="mt-10 space-y-10 text-slate-600">
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-slate-900">Information we collect</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-slate-900">How we use information</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-slate-900">Cookies and tracking</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-slate-900">Business service requests</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold tracking-[-0.01em] text-slate-900">Contact and data questions</h2>
