      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-400">Refund Policy</p>
            <h1 className="mt-6 text-4xl font-bold tracking-[-0.02em] text-slate-950 sm:text-5xl">Refund and service review policy.</h1>
            ...
            <div className="mt-8 rounded-[1.2rem] border border-slate-200/60 bg-slate-50/70 p-6">
              <h2 className="text-[17px] font-semibold tracking-[-0.01em] text-slate-900">Need help?</h2>
