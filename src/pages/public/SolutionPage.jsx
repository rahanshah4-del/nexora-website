...
const solutionPages = {
  ...
  'pos': {
    ...
    description: 'A cloud-based, desktop, web and mobile-ready POS for billing, inventory, receipt printing, reports, staff roles and secure cloud sync.',
    ...
    faqs: [
      ...
      ['Is Nexora POS a cloud-based (SaaS) POS system?', 'Yes. Nexora POS is a cloud-based SaaS platform available on desktop, web and mobile, with offline billing support so your counter keeps working without internet — sales sync automatically to the cloud once you reconnect.'],
    ],
  },
  'retail-pos': {
