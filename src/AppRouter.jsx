...
// (see the top-level "/pos-till/medical" route below), so it gets none of
...
export default function AppRouter() {
  ...
  return (
    <>
      ...
      {/* Standalone, chrome-free Medical Store POS billing till — no DashboardLayout,
          no Sidebar, no TopNav. Opened in a new tab from the sidebar's medicalPos
          item (see Sidebar.jsx). Auth-gated only by CrmRequireAuth here; module/plan
          gating is replicated inside MedicalPosTillGate since this route sits
          outside DashboardLayout's own gating. */}
      <Route
        path="/pos-till/medical"
        element={
          <LazyPage>
            <CrmRequireAuth>
              <MedicalPosTillGate />
