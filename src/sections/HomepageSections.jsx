...
export default function HomepageSections() {
  ...
  return (
    <>
      <section data-reveal data-ai-animate="glow-pulse" className="bg-white py-16 sm:py-20 lg:py-24">
      ...
      <section data-reveal data-ai-animate="scan-line" className="bg-white px-5 pb-16 pt-2 sm:px-6 sm:pb-20 lg:px-8 lg:pb-24">
      ...
      <section data-reveal data-ai-animate="neural-pulse" className="bg-white px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      ...
      <section data-reveal data-ai-animate="data-stream" className="bg-white px-5 pb-16 sm:px-6 sm:pb-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl items-center gap-6 rounded-[2rem] border border-blue-100 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_58%,#e0f2fe_100%)] p-6 shadow-[0_30px_90px_-60px_rgba(37,99,235,0.44)] sm:p-8 lg:grid-cols-[1fr_auto]">
