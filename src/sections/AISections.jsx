  ...
  return (
    <>
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section data-reveal data-ai-animate="glow-pulse" className="relative overflow-hidden bg-white py-16 sm:py-20 lg:py-24">
      ...
      <section data-reveal data-ai-animate="scan-line" className="bg-[linear-gradient(180deg,#faf5ff_0%,#ffffff_100%)] py-16 sm:py-20 lg:py-24">
      ...
      {/* PHASE 1 — AI WORKFLOW */}
      <section data-reveal data-ai-animate="neural-pulse" className="bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
      ...
      {/* PHASE 1 — AI CTA */}
      <section data-reveal data-ai-animate="data-stream" className="relative overflow-hidden bg-white px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
