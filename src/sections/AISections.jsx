      ...
      <section data-reveal className="bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { label: 'AI Dashboard', desc: 'Real-time AI-powered business overview with smart alerts and predictions', icon: '📊', bg: 'from-amber-50 to-orange-50', iconBg: 'bg-gradient-to-br from-amber-400 to-orange-500' },
              { label: 'AI Chat Assistant', desc: '24/7 intelligent assistant in English & Urdu — answers, analyzes, recommends', icon: '💬', bg: 'from-violet-50 to-purple-50', iconBg: 'bg-gradient-to-br from-violet-400 to-purple-500' },
              { label: 'AI Menu Import', desc: 'Upload a menu photo — AI extracts 100+ items with prices & categories instantly', icon: '📸', bg: 'from-sky-50 to-blue-50', iconBg: 'bg-gradient-to-br from-sky-400 to-blue-500' },
              { label: 'AI Analytics', desc: 'Deep sales pattern analysis with predictive trends and anomaly detection', icon: '📈', bg: 'from-emerald-50 to-green-50', iconBg: 'bg-gradient-to-br from-emerald-400 to-green-500' },
              { label: 'AI Reports', desc: 'One-click P&L, inventory valuation, tax summaries — AI finds the insights', icon: '📄', bg: 'from-rose-50 to-pink-50', iconBg: 'bg-gradient-to-br from-rose-400 to-pink-500' },
              { label: 'AI Business Insights', desc: 'Daily briefings: what sold, what\'s low, what to reorder, who to follow up with', icon: '💡', bg: 'from-indigo-50 to-blue-50', iconBg: 'bg-gradient-to-br from-indigo-400 to-blue-500' },
            ].map((item) => (
