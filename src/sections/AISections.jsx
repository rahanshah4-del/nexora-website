    ...
    <>
      ...
      <section data-reveal  className="relative overflow-hidden bg-white px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-6 rounded-[2rem] border border-violet-100/60 bg-[linear-gradient(135deg,#faf5ff_0%,#ffffff_48%,#f5f3ff_100%)] p-6 shadow-[0_30px_90px_-60px_rgba(139,92,246,0.3)] sm:p-8 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-8 text-slate-600">Start your 1-month free trial — no credit card required. Or book a live demo and let our experts show you how Nexora AI transforms your business.</p>
          </div>
      ...
      <section data-reveal  className="relative overflow-hidden bg-white px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-600">1-month free trial. No credit card. No setup fees. Full access to every AI-powered module.</p>
